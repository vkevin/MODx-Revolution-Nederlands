...
$_lang['credits_xpdo'] = 'MODx gebruikt de database ORM van <a href="http://www.xpdo.org/" target="_blank">xPDO</a>.';
$_lang['help_msg'] = '<p>Support kun je gratis verkrijgen via de <a href="http://modxcms.com/forums/" target="_blank">MODx Community Forums</a>. Naast community support kun je ook terecht bij de <a href="http://docs.modxcms.com/display/revolution" target="_blank">MODx Revolution documentatie</a>, die constant wordt bijgewerkt.</p><p>Voor bugs kun je terecht bij de <a href="http://bugs.modxcms.com/" target="_blank">MODx JIRA Issue Tracker</a>.</p>';
